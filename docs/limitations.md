...
- `brand_gen/brand_iterate_mcp.py` still carries two intentional custom MCP handlers (`brand_inspire`, `brand_pipeline`) instead of being a pure CLI passthrough surface
...
- business logic lives under `brand_gen/`
