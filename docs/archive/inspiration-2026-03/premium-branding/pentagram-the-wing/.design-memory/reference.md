...
- Source: Pentagram — The Wing
- URL: https://www.pentagram.com/work/the-wing
- Extractor: built-in semantic extraction
- Mode: metadata-plus-fetch
- Best for: motif, application
- Borrow mechanics: multi-surface system thinking, environmental consistency, identity extension logic
- Avoid literal: their letterforms, their editorial voice, their exact collateral
