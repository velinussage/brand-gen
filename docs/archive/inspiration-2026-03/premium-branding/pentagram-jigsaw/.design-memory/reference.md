...
- Source: Pentagram — Jigsaw
- URL: https://www.pentagram.com/work/jigsaw
- Extractor: built-in semantic extraction
- Mode: metadata-plus-fetch
- Best for: composition reasoning
- Borrow mechanics: edge tension, restraint, editorial hierarchy
- Avoid literal: their letterforms, their identity geometry, their collateral styling
