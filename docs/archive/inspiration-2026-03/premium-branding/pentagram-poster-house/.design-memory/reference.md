...
- Source: Pentagram — Poster House
- URL: https://www.pentagram.com/work/poster-house
- Extractor: built-in semantic extraction
- Mode: metadata-plus-fetch
- Best for: application, poster reasoning
- Borrow mechanics: poster application logic, print hierarchy, modular framing
- Avoid literal: their typography, their logo system, their exact poster layouts
