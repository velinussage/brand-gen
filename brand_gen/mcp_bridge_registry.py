...
COMMAND_OVERRIDES: dict[str, McpBridgeOverride] = {
    ...
    "list-brands": McpBridgeOverride(tool_name="brand_list_brands", argv_defaults={"format": "json"}),
    "switch-brand": McpBridgeOverride(argv_defaults={"format": "json"}),
    "get-pending-reviews": McpBridgeOverride(argv_defaults={"format": "json"}),
    "get-policy": McpBridgeOverride(argv_defaults={"format": "json"}),
    "set-policy": McpBridgeOverride(argv_defaults={"format": "json"}),
    "approve-action": McpBridgeOverride(argv_defaults={"format": "json"}),
    "reject-action": McpBridgeOverride(argv_defaults={"format": "json"}),
    ...
    "list-aesthetic-capsules": McpBridgeOverride(argv_defaults={"format": "json"}),
    "suggest-aesthetic-directions": McpBridgeOverride(argv_defaults={"format": "json"}),
    "promote-aesthetic-learning": McpBridgeOverride(argv_defaults={"format": "json"}),
