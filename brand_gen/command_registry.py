...
from .commands.inspection import (
    ...
    cmd_list_runs,
    cmd_list_aesthetic_capsules,
    cmd_suggest_aesthetic_directions,
    cmd_prompts_get,
    cmd_prompts_list,
    cmd_show,
    cmd_show_blackboard,
...
from .commands.state import (
    ...
    cmd_bootstrap,
    cmd_contract_status,
    cmd_render_iteration_memory,
    cmd_sage_approved_phrase_add,
    cmd_sage_approved_phrase_remove,
    cmd_sage_brand_anchor_source_add,
    cmd_sage_brand_anchor_source_remove,
    cmd_sage_illustration_concept_add,
    cmd_sage_illustration_concept_remove,
    cmd_sage_negative_constraint_add,
    cmd_sage_negative_constraint_remove,
    cmd_framing_direction_add,
    cmd_framing_direction_remove,
    cmd_lexicon_token_add,
    cmd_lexicon_token_remove,
    cmd_product_term_add,
    cmd_product_term_remove,
    cmd_create_brand,
    ...
    cmd_promote_aesthetic_learning,
...
FEATURE_TAGS_BY_COMMAND: dict[str, tuple[str, ...]] = {
    ...
    "contract-status": ("context", "contract"),
    "render-iteration-memory": ("mutation", "iteration-memory"),
    "sage-approved-phrase-add": ("mutation", "brand-contract"),
    "sage-approved-phrase-remove": ("mutation", "brand-contract"),
    "sage-negative-constraint-add": ("mutation", "brand-contract"),
    "sage-negative-constraint-remove": ("mutation", "brand-contract"),
    "sage-illustration-concept-add": ("mutation", "brand-contract"),
    "sage-illustration-concept-remove": ("mutation", "brand-contract"),
    "sage-brand-anchor-source-add": ("mutation", "brand-contract"),
    "sage-brand-anchor-source-remove": ("mutation", "brand-contract"),
    "framing-direction-add": ("mutation", "brand-contract"),
    "framing-direction-remove": ("mutation", "brand-contract"),
    "product-term-add": ("mutation", "brand-contract"),
    "product-term-remove": ("mutation", "brand-contract"),
    "lexicon-token-add": ("mutation", "brand-contract"),
    "lexicon-token-remove": ("mutation", "brand-contract"),
...
COMMAND_SPECS = [
    ...
    command_spec('list-aesthetic-capsules', cmd_list_aesthetic_capsules, 'List curated aesthetic capsules and prompt previews for style/moodboard selection.', read_only=True),
    command_spec('suggest-aesthetic-directions', cmd_suggest_aesthetic_directions, 'Suggest 2-3 contrasting aesthetic/moodboard branches before planning.', read_only=True),
    ...
    command_spec('contract-status', cmd_contract_status, 'Show brand contract location, schema-validation status, read-only-after files, and recent state mutations.', read_only=True),
    command_spec('render-iteration-memory', cmd_render_iteration_memory, 'Re-render <brand>/iteration-memory.md from iteration-memory.json (idempotent; PR-10 dual-write resolution).'),
    command_spec('sage-approved-phrase-add', cmd_sage_approved_phrase_add, 'Append a Sage approved-phrase to the brand contract with audit-logged provenance.'),
    command_spec('sage-approved-phrase-remove', cmd_sage_approved_phrase_remove, 'Remove a Sage approved-phrase from the brand contract.'),
    command_spec('sage-negative-constraint-add', cmd_sage_negative_constraint_add, 'Append a Sage negative-constraint to the brand contract.'),
    command_spec('sage-negative-constraint-remove', cmd_sage_negative_constraint_remove, 'Remove a Sage negative-constraint from the brand contract.'),
    command_spec('sage-illustration-concept-add', cmd_sage_illustration_concept_add, 'Append a Sage illustration concept to the brand contract.'),
    command_spec('sage-illustration-concept-remove', cmd_sage_illustration_concept_remove, 'Remove a Sage illustration concept from the brand contract.'),
    command_spec('sage-brand-anchor-source-add', cmd_sage_brand_anchor_source_add, 'Append a Sage brand-anchor source to the brand contract.'),
    command_spec('sage-brand-anchor-source-remove', cmd_sage_brand_anchor_source_remove, 'Remove a Sage brand-anchor source from the brand contract.'),
    command_spec('framing-direction-add', cmd_framing_direction_add, 'Add or update a framing direction. Structured fields go to brand contract; prose lands in <brand>/voice/framing/<id>.md.'),
    command_spec('framing-direction-remove', cmd_framing_direction_remove, 'Remove a framing direction. Deletes both the JSON entry and the voice/framing/<id>.md unless --keep-voice is passed.'),
    command_spec('product-term-add', cmd_product_term_add, 'Append an allowed or banned product-truth term to brand contract product_terms.* with audit-logged provenance.'),
    command_spec('product-term-remove', cmd_product_term_remove, 'Remove a product-truth term from brand contract product_terms.*.'),
    command_spec('lexicon-token-add', cmd_lexicon_token_add, 'Append a lexicon token (capability/governance_process/governance_education) to brand contract lexicon.* with audit-logged provenance.'),
    command_spec('lexicon-token-remove', cmd_lexicon_token_remove, 'Remove a lexicon token from brand contract lexicon.*.'),
    ...
    command_spec('promote-aesthetic-learning', cmd_promote_aesthetic_learning, 'Record an aesthetic capsule like/dislike in brand aesthetic-preferences.json.'),
